<div class="col-sm-9 col-md-10 main">
    ...
    <legend>Supplier Info</legend>
      ...
      <div class="form-group">
            ...
            <div class="col-xs-3">
                <input type="text" class="form-control"  value="<?php echo $estimationlist->getSupplier()->getTelephone(); ?>" id="phone" placeholder="Phone Number" name="phone">
            </div>
       </div>
        <div class="form-group">
...
<script src="<?php echo base_url(); ?>assets/js/edit_estimate.js"></script>
