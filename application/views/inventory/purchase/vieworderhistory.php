...
<?php foreach($order as $ord):?>
		...
		<div class="form-group" >
           <label class="control-label col-xs-3" for="supplierTelephone"><b>SupplierTelephone:</b></label>
			  <p><?php echo $suppliers->getSupplier()->getMobile();?></p>
        </div>
		
      <div class="form-group" >
           <label class="control-label col-xs-3" for="OrderDate"><b>OrderDate:</b></label>
			  <p><?php $data= $ord->getCreatedDate();echo date("d-m-Y", $data);?></p>
        </div>
<?php endforeach; ?>		
	 <br>
...
<table class="table table-bordered">
           ...
           <a type="button" href="<?php echo base_url();?>inventory/purchase/orderhistory" class="btn btn-default btn-xs">Done</a>
