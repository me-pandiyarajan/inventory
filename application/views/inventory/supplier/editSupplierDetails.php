	        			...
	        			?>
						   ...
						   <div class="form-group">
						      <label for="name" class="col-sm-2 control-label">Mobile</label>
						      	<div class="col-sm-3">
						      		<input type="text" class="form-control"  id="mobile" name="mobile" value="<?php echo $supplier->getMobile(); ?>" placeholder="Enter mobile number">
						   		</div>
						   </div>
						   ...
						   <!-- action -->
						    ...
						    <div class="form-group">
							    <div class="col-sm-offset-2 col-sm-10">
							      ...
							      <a type="button" href="<?php echo base_url();?>inventory/supplier/listsuppliers" class="btn btn-default btn-xs">Cancel</a>
							    </div>
							</div>
