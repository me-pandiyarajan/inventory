					...
					<table class="table table-bordered" >
						...
						<tbody role="alert" aria-live="polite" aria-relevant="all">
							...
							<tr> 
								...
								<td>
									<div class="btn-group">
									  	<a type="button" href="<?php echo site_url()."supplier/supplierDetails/".$supplier->getSupplierId()."/editSupplierDetails";?>" class="btn btn-primary btn-xs">Edit</a>
									  		<?php if( $visiblity == 1 ): ?>
		<a type="button" href="<?php echo site_url()."supplier/deletesupplier/".$supplier->getSupplierId();?>" class="btn btn-primary btn-xs">Delete</a>
									  	<?php endif;	?>
									</div>
								</td>
							</tr>	
