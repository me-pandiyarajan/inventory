...
class Products
{
     ...
     *
     * @Column(name="upload_image", type="string", length=45, nullable=true)
     */
    private $uploadImage;
     ...
     * @var integer $track
     *
     * @Column(name="track", type="integer", nullable=true)
     */
    private $track;
     ...
     * @return Products
     */
    public function setTaxClassTaxClass( $taxClassTaxClass = null)
    {
