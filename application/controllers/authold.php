...
function view_profile($id)
	...
	$this->navigator->checkLogin(); 
	$user = $this->ion_auth->user($id)->row();
	$this->form_validation->set_rules('first_name', $this->lang->line('view_profile_validation_fname_label'), 'required|xss_clean');
	$this->form_validation->set_rules('last_name', $this->lang->line('view_profile_validation_lname_label'), 'required|xss_clean');
	$this->form_validation->set_rules('email', $this->lang->line('view_profile_validation_email_label'), 'required|xss_clean');
	$this->form_validation->set_rules('phone', $this->lang->line('view_profile_validation_phone_label'), 'required|xss_clean');
	if (isset($_POST) && !empty($_POST))
		{
			// do we have a valid request?
			if ($this->_valid_csrf_nonce() === FALSE || $id != $this->input->post('id'))
