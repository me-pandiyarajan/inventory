...
class Return_damage extends CI_Controller {
	...
	public function returnSale()
	{
	    ...
	    $discount = $this->input->post('discount_prices');
	    $tax = $this->input->post('taxs');
	    $amount = $this->input->post('totals');
	    $unitprices = $this->input->post('prices');
		    ...
		    { 
			  	...
			  	$pos_return->setUnitprice($unitprices[$i]);
			  	$pos_return->setDiscount($discount[$i]);
			  	$unixtime = time();
	 ...
	 public function damaged()
	 {
	    ...
	    $unitprices = $this->input->post('prices');
		    ...
		    { 
			  ...
			  $pos_damage->setUnitprice($unitprices[$i]);
			  $pos_damage->setDiscount($discount[$i]);
			  $unixtime = time();
