...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2014 at 05:53 PM
...
INSERT INTO `suppliers` (`supplier_id`, `supplier_name`, `telephone`, `email`, `street`, `state`, `zip_code`, `city`, `country`, `status`, `created_date`, `last_updated_date`, `created_by`, `last_updated_by`, `deleted`) VALUES
...
(9, 'Supplier Test', 2147483647, 'steffjemima@gmail.com', '', 'd', 23432, '@#', NULL, 0, NULL, NULL, NULL, NULL, 0),
...
(1, '127.0.0.1', 'super administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'superadmin@inventory.com', '', NULL, NULL, '10bd3f40a4ebb18c8e7165019d352680f5f34bc7', 1268889823, 1400855141, 1, 'super', 'admin', 'ADMIN', '1111111111', 0),
(2, '127.0.0.1', 'admin', '$2y$08$HjmKuq5Y3AFlCg9oVStHneHubDrDaiNPAdn18UCy2TOwiEjK.iOKy', NULL, 'admin@inventory.com', NULL, NULL, NULL, NULL, 1397736034, 1400854982, 1, 'admin', 'admin', 'test', '2222222228', 0),
