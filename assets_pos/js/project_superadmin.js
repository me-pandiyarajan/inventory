         ...
         $.each(product.unsoldlist, function(index,key){
                  ...
                  newRow = '<tr>' +
                        ...
                        '<td >'+ key.Plu +' <input type="hidden" name="plu[]" value="'+ key.Plu +'" /></td>' +
                         ...
                         '<td ><input type="text" actual-unit-price="'+ key.Price +'" name="price[]" class="form-control price" value="'+ key.Price +'" /> </td>' +
                         ...
                         '<td >'+ key.Unit +'</td>' +
                         '<td ><input type="hidden" class="form-control" id="discount" name="discount[]" value="'+ key.Discount +'" /></td>' +
    ...
    function addProduct(product)
    {
        ...
        if(x <= MaxInputs) 
        {
            ...
            newRow = '<tr>' +
                        ...
                        '<td ><input type="text" actual-unit-price="'+ price +'" name="price[]" class=" form-control price" value="'+ price +'" /> </td>' +
                        '<td ><input type="text" class="form-control quantity" price-id="'+ p_id +'" actual-unit-price="'+ price +'" name="quantities[]" value="'+ quan +'" /> </td>' +
                        '<td >'+ product.unit +'</td>' +
                        '<td ><input type="hidden" class="form-control" id="discount" name="discount[]" value="-" /></td>' +
